...
LEAN = Path("lean/URF/Foundation/FiniteMarkovEvolutionPreservesDistributionsTheorem.lean")
DOC = Path("docs/status/FINITE_MARKOV_EVOLUTION_PRESERVES_DISTRIBUTIONS_THEOREM_2026_06_02.md")
...
assert "import URF.Foundation.FiniteMarkovEvolutionPreservesDistributionsTheorem" in root

for phrase in [
    "bounded finite-state Markov-evolution theorem only",
...
print("FINITE_MARKOV_EVOLUTION_PRESERVES_DISTRIBUTIONS_THEOREM_OK")
