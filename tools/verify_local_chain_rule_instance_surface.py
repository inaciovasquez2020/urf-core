...
LEAN = ROOT / "local_chain_rule_instance_surface.lean"
DOC = ROOT / "docs/status/LOCAL_CHAIN_RULE_INSTANCE_SURFACE_2026_05_26.md"
...
def main() -> None:
    ...
    required_lean = [
        "structure LocalChainRuleInstanceData",
    ...
    required_doc = [
        "INSTANCE_LEVEL_CHAIN_RULE_SURFACE_ONLY",
    ...
    print("LOCAL_CHAIN_RULE_INSTANCE_SURFACE_OK")
