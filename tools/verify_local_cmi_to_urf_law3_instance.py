...
LEAN = ROOT / "local_cmi_to_urf_law3_instance.lean"
DOC = ROOT / "docs/status/LOCAL_CMI_TO_URF_LAW3_INSTANCE_2026_05_26.md"
...
def main() -> None:
    ...
    required_lean = [
        "structure LocalURFLaw3InstanceData",
        "localCMI_nonneg",
        "local_chain_rule",
        "local_capacity",
    ...
    print("LOCAL_CMI_TO_URF_LAW3_INSTANCE_OK")
