...
Framework/dependency layer. Axioms are dependencies, not theorem proofs.
...
`urf-core` is a conditional frontier artifact, not a theorem-complete Lean proof repository.
