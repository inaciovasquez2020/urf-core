...
def test_global_valid_kernel_theorem_target_verifier_exists():
    assert VERIFY.exists(), f"missing verifier: {VERIFY}"
    assert VERIFY.is_file(), f"verifier is not a file: {VERIFY}"
