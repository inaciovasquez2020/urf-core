...
def test_eclipse_status_invariance_bridge_certified_lock():
    text = Path("docs/math/ECLIPSE_STATUS_INVARIANCE_BRIDGE_CERTIFIED.md").read_text(encoding="utf-8")
    assert "# Eclipse Status Invariance Bridge Certified" in text
